    ...
    <div className='mx-8 bg-white w-4/5 rounded-lg p-5 mb-6'>
      ...
      <div className='flex justify-between mt-3'>
        <div className='flex justify-between'>
          ...
          <p className='mx-2'  >Development Apps</p>
          <svg className='mx-2' xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 sm:grid-cols-1 gap-2 '>
        ...
        <div className='flex m-5'>
          ...
          <p className='mx-4'> Priority Enabled</p>
        </div>
